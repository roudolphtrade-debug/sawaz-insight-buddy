 ...
 * Précédent, onglets déjà visités dans ProgressBar, retour navigateur) pour déclencher
 * un flush immédiat des réponses en attente avant que la navigation n'aboutisse.
 *
